              ...
              <article class="single-blog-content-wrap">
                ...
                <section class="blog-details">
                  ...
                  <p>
                    ...
                    lorem. Donec tempor arcu nisl, et molestie massa hhisque ut.
                    Nunc at rutrum leo. Mauris metus mauris, tridd.
                  </p>
                  <p>
                    ...
                    tortor, sit amet ntum mi ligula sit amet augue. Pellentesqs
                    placerat.
                  </p>
                  <img src={images.blog3} class="img-fluid" alt="Blog" />
                  <div class="row">
                    <div class="col-lg-6">
                      <h5>The Guest Series</h5>
                      <p>
                        Mauris tempus erat laoreet turpis lobortis, eu tincidunt
                        erat fermentum. Aliquam non tidunt urna. Integer
                        tincidunt nec nisl vitae Proin sed ultrices erat.
                      </p>
                    </div>
                    <div class="col-lg-6">
                      <h5>How and why</h5>
